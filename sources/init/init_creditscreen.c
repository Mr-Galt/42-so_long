...
void	init_creditscreen_m(t_game *game)
{
	...
	game->start_menu->creditscreen_m[0] = mlx_xpm_file_to_image(game->mlx, M_CREDITSCREEN_0, &width, &height);
	game->start_menu->creditscreen_m[1] = mlx_xpm_file_to_image(game->mlx, M_CREDITSCREEN_1, &width, &height);
}
...
void	init_creditscreen_l(t_game *game)
{
	...
	game->start_menu->creditscreen_l[0] = mlx_xpm_file_to_image(game->mlx, L_CREDITSCREEN_0, &width, &height);
