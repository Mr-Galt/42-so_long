...
/*   Updated: 2023/12/14 10:08:55 by mheinke          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	change_to_s(t_game *game)
{
	...
	game->win = mlx_new_window(game->mlx, game->screen_height,
			game->screen_width, "OFFSET S");
