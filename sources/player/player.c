...
/*   Updated: 2023/12/22 15:02:43 by mheinke          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	player_viewport(t_game *game)
{
	...
	// ft_printf("Player Y: %d, Camera Y: %d, Map Height: %d\n", game->player->position[1], game->camera_y, game->map_px_height);
	// ft_printf("Camera X: %d, Camera Y: %d\n", game->camera_x, game->camera_y);
